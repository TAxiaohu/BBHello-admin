/**
 * Created by liusong on 15/11/10.
 */
(function () {
  'use strict';
  ...
  angular
    ...
    .controller('VisitsCtrl', ["$scope", function ($scope) {
    ...
    .controller('OnotherCtrl', ["$scope", function ($scope) {
    ...
    .controller('LastCtrl', ["$scope", function ($scope) {
