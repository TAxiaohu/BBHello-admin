...
(function () {
  ...
  /* @ngInject */
  function articleCreateController($state,toastr,config,FileUploader,dateFilter,UploaderService,EditorUploaderService,ConsultingService) {
    var vm = this;
    var queue = [];
    vm.cancel = cancel;
    vm.submit = submit;
