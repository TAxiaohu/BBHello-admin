...
(function () {
  ...
  angular
    ...
    .controller('consultingCreateController', consultingCreateController);

  /* @ngInject */
  function consultingCreateController($state, toastr, config,dateFilter, FileUploader, UploaderService, EditorUploaderService, ConsultingService) {
    var vm = this;
    var queue= [];
    vm.cancel = cancel;
    vm.submit = submit;
