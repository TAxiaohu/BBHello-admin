...
(function () {
  ...
  angular
    ...
    .controller('technologyEditController', technologyEditController);

  /* @ngInject */
  function technologyEditController($state,$stateParams,toastr,config,dateFilter,FileUploader,UploaderService,EditorUploaderService,ConsultingService) {
    var vm = this;
    var queue= [];
    vm.cancel = cancel;
    vm.submit = submit;
