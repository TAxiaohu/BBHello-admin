...
(function () {
  ...
  angular
    ...
    .controller('technologyListController', technologyListController);

  /* @ngInject */
  function technologyListController($state, toastr,ngTableParams, dateFilter,ConsultingService) {
    var vm = this;
    ...
    //跳转新增页面
    function gotoCreate() {
      $state.go('app.technology.create');
    }
    //删除
    ...
    function gotoEdit(params) {
      ...
      $state.go('app.technology.edit',{contentId: params.contentId});
    }
